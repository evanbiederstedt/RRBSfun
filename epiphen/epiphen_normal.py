...
import os
os.chdir("/Users/evanbiederstedt/Downloads/correct_phylo_files")


normalB_files = glob.glob("binary_position_RRBS_normal_B_cell*")
pcellmcell = glob.glob("binary_position_RRBS_NormalBCD19*")
print(len(normalB_files))
print(len(pcellmcell))


totalfiles = normalB_files + pcellmcell
...
tott.to_csv("normal_total.phy", header=None, index=None)
