...
normalB_cellbatch_mcell1_22 = glob.glob("RRBS_NormalBCD19pCD27mcell1_22*.anno")


newdf1 = pd.DataFrame()
for filename in normalB_cellbatch_mcell1_22:
...
# export as .csv
newdf1.to_csv('PDR_genomicRegions_RRBS_NormalBCD19pCD27mcell1_22.csv')
